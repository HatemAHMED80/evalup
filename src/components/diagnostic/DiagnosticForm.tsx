...
export function DiagnosticForm({ className, embedded = false }: DiagnosticFormProps) {
  ...
  return (
    <div className={className ?? "min-h-[calc(100vh-var(--nav-height))] bg-[var(--bg-primary)] flex flex-col items-center justify-center px-6 py-8"}>
      {/* Progress bar */}
      {embedded ? (
        <div className="w-full max-w-lg h-1 bg-[var(--border)] mb-6 rounded-full overflow-hidden">
          <div
